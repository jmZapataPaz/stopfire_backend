...
public class AdminCrearBomberoDto
{
    ...
    [Required, MinLength(3)] public string Ci { get; set; } = string.Empty;
    ...
    [Required, MinLength(8)] public string Contrasena { get; set; } = string.Empty;
}